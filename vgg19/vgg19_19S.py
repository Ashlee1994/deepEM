...
class Vgg19:
    ...
    def variables_deepem(self):
        ...
        self.data_dict = {
            ...
            'conv1_1': {'filter': [7,7,1,  64],  'biases': [64]},
            'conv1_2': {'filter': [7,7,64, 64],  'biases': [64]},
            'conv2_1': {'filter': [7,7,64, 128], 'biases':[128]},
            'conv2_2': {'filter': [7,7,128,128], 'biases':[128]},
            'conv3_1': {'filter': [7,7,128,256], 'biases':[256]},
            'conv3_2': {'filter': [7,7,256,256], 'biases':[256]},
            'conv3_3': {'filter': [7,7,256,256], 'biases':[256]},
            'conv3_4': {'filter': [7,7,256,256], 'biases':[256]},
            'conv4_1': {'filter': [7,7,256,512], 'biases':[512]},
            'conv4_2': {'filter': [7,7,512,512], 'biases':[512]},
            'conv4_3': {'filter': [7,7,512,512], 'biases':[512]},
            'conv4_4': {'filter': [7,7,512,512], 'biases':[512]},
            'conv5_1': {'filter': [7,7,512,512], 'biases':[512]},
            'conv5_2': {'filter': [7,7,512,512], 'biases':[512]},
            'conv5_3': {'filter': [7,7,512,512], 'biases':[512]},
            'conv5_4': {'filter': [7,7,512,512], 'biases':[512]},
        ...
        self.data_dict = {
            # filter = [kernelsize, kernelsize, last_layser_feature_map_num, feature_map_num]
            # biases = [feature_map_num]
            'conv1_1': {'filter': [5,5,1,  64],  'biases': [64]},
            'conv1_2': {'filter': [5,5,64, 64],  'biases': [64]},
            'conv2_1': {'filter': [5,5,64, 128], 'biases':[128]},
            'conv2_2': {'filter': [5,5,128,128], 'biases':[128]},
            'conv3_1': {'filter': [5,5,128,256], 'biases':[256]},
            'conv3_2': {'filter': [5,5,256,256], 'biases':[256]},
            'conv3_3': {'filter': [5,5,256,256], 'biases':[256]},
            'conv3_4': {'filter': [5,5,256,256], 'biases':[256]},
            'conv4_1': {'filter': [5,5,256,512], 'biases':[512]},
            'conv4_2': {'filter': [5,5,512,512], 'biases':[512]},
            'conv4_3': {'filter': [5,5,512,512], 'biases':[512]},
            'conv4_4': {'filter': [5,5,512,512], 'biases':[512]},
            'conv5_1': {'filter': [5,5,512,512], 'biases':[512]},
            'conv5_2': {'filter': [5,5,512,512], 'biases':[512]},
            'conv5_3': {'filter': [5,5,512,512], 'biases':[512]},
            'conv5_4': {'filter': [5,5,512,512], 'biases':[512]},
            'fc6': {'filter': [], 'biases':[4096]},    # 4096,
            'fc7': {'filter': [4096, 4096], 'biases':[4096]},    # 4096,
            'fc8': {'filter': [4096,    1], 'biases':[1]}   # 1
        }
